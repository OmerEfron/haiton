...
const PLAN_ROUTES: { method: string; path: string; handler?: string }[] = [
  ...
  { method: "GET", path: "/editions/:userId", handler: "getUserEdition" },
  { method: "GET", path: "/stories/:id", handler: "getStory" },
  { method: "GET", path: "/stories/share/:token", handler: "getSharedStory" },
  ...
  { method: "GET", path: "/invitations/preview/:token", handler: "previewInvitation" },
  { method: "POST", path: "/invitations/join", handler: "joinInvitation" },
  ...
  { method: "POST", path: "/desk/credits" },
  { method: "GET", path: "/desk/brief", handler: "getBrief" },
